...
##
# This is a snippet for showcasing how to alter table with foreign key delete cascade.
#
# @param project_id  [String] The ID of the Google Cloud project.
# @param instance_id [String] The ID of the spanner instance.
# @param database_id [String] The ID of the database.
#
def spanner_alter_table_with_foreign_key_delete_cascade project_id:, instance_id:, database_id:
  ...
  job.wait_until_done!
  puts "Altered ShoppingCarts table with FKShoppingCartsCustomerName\
