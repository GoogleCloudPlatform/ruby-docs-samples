...
require_relative "../spanner_drop_foreign_key_constraint_delete_cascade"
...
describe "Google Cloud Spanner Foreign key cascade examples" do
  ...
  example "spanner_drop_foreign_key_constraint_delete_cascade" do
    capture do
       spanner_drop_foreign_key_constraint_delete_cascade project_id: @project_id,
                                                          instance_id: @instance_id,
                                                          database_id: @fkdc_database_id
    end

    expect(captured_output).to include "Altered ShoppingCarts table to drop FKShoppingCartsCustomerName"
