...
require_relative "../spanner_postgresql_dml_getting_started_update"
...
describe "Google Cloud Spanner Postgres examples" do
  ...
  example "spanner_postgresql_dml_getting_started_update" do
    database = create_spangres_singers_albums_database
    create_spangres_singers_table
    capture do
      spanner_postgresql_dml_getting_started_update project_id: @project_id,
