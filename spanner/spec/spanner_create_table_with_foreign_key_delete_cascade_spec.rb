...
describe "Google Cloud Spanner Foreign key cascade examples" do
  ...
  example "spanner_create_table_with_foreign_key_delete_cascade" do
    capture do
    ...
    expect(captured_output).to include "Created Customers and ShoppingCarts table with FKShoppingCartsCustomerId"
