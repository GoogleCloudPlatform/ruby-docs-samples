...
describe "Google Cloud Spanner Database roles" do
  ...
  example "Add and Drop roles" do
    ...
    expect(captured_output).to include "Created roles new_parent and new_child and granted privileges"
    expect(captured_output).to include "Revoked privileges and dropped role new_child"
  end
end
