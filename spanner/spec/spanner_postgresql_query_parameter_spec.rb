...
require_relative "../spanner_postgresql_query_parameter"
...
describe "Google Cloud Spanner Postgres examples" do
  ...
  example "spanner_postgresql_query_parameter" do
    ...
    capture do
      spanner_postgresql_query_parameter project_id: @project_id,
    ...
    expect(captured_output).to include "LastName: Louis"
  end
end
