...
describe "PubSub Quickstart" do
  ...
  it "creates a new topic" do
    ...
    pubsub_test_client = gcloud_test_client.pubsub

    # Prime PubSub for test
    if pubsub_test_client.topic "my-new-topic"
      pubsub_test_client.topic("my-new-topic").delete
    end

    expect(pubsub_test_client.topic "my-new-topic").to be nil
    ...
    expect(pubsub_test_client.topic "my-new-topic").not_to be nil
   end
