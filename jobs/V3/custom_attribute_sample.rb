...
def job_discovery_generate_job_with_custom_attribute company_name:
	...
	custom_attributes["someFieldName1"] = jobs::CustomAttribute.new :string_values => Array["value1"],
																   :filterable => true
	# Second custom attribute
	custom_attributes["someFieldName2"] = jobs::CustomAttribute.new :long_values => Array[256],
																   :filterable => true
...
def job_discovery_filters_on_long_value_custom_attribute project_id:
	...
	job_query = jobs::JobQuery.new :custom_attribute_filter => "(255 <= someFieldName2) AND (someFieldName2 <= 257)"
...
def run_custom_attribute_sample arguments
	...
	if !company_got_test.nil?
		job_generated_test = job_discovery_generate_job_with_custom_attribute company_name: company_got_test.name
...
Commands:
  filters_on_long_value_custom_attribute           <company_name>        Filter jobs on long value customer attribute under given comany.
  filters_on_string_value_custom_attribute         <company_name>        Filter jobs on string value customer attribute under given comany.
  filters_on_multi_custom_attributes               <company_name>        Filter jobs on multi customer attributes under given comany.
