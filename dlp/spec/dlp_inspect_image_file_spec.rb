...
describe "DLP inspect image file sample" do

  it "can inspect name and email address in an image file" do
    project_id = ENV["GOOGLE_CLOUD_PROJECT"]
    current_directory = File.expand_path(File.dirname(__FILE__))
    resource_filepath = File.join current_directory, "data", "test.png"
    snippet_filepath  = File.join current_directory, "..",
                                  "dlp_inspect_image_file.rb"
