# Ruby Google Cloud Tasks sample for Google App Engine Standard

This sample application shows how to use [Google Cloud Tasks](https://cloud.google.com/cloud-tasks/)
on Google App Engine [standard environment][appengine-standard].
...
[appengine-flex]: https://cloud.google.com/appengine/docs/standard/ruby
